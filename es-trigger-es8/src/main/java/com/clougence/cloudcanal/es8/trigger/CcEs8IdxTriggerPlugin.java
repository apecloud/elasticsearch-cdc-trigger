...
public class CcEs8IdxTriggerPlugin extends Plugin {
    ...
    public static final Setting<String> nodeTriggerIdxs = Setting.simpleString(EsTriggerConstant.NODE_TRIGGER_IDXS,
            Setting.Property.NodeScope, Setting.Property.Dynamic);
    ...
    public Collection<?> createComponents(PluginServices services) {
        ...
        try {
            clusterSettings = services.clusterService().getClusterSettings();
