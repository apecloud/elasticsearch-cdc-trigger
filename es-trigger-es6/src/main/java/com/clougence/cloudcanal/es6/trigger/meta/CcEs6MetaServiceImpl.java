package com.clougence.cloudcanal.es6.trigger.meta;
...
import com.clougence.cloudcanal.es6.trigger.ds.Es6ClientHelper;
...
public class CcEs6MetaServiceImpl implements CcMetaService {

    private static final Logger log = LoggerFactory.getLogger(CcEs6MetaServiceImpl.class);
    ...
    public void createTriggerIdx(EsConnConfig connConfig) {
        try {
            ...
            mapping.put(EsTriggerConstant.ES6_DOC_TYPE, typeMapping);
    ...
    public void upsertIndexSettings(EsConnConfig connConfig, List<String> indexes, Map<String, Object> settings) {
        try {
            ...
            try (RestHighLevelClient esClient = Es6ClientHelper.generateEsClient(connConfig)) {
    ...
    protected void createIdx(String indexName, Map<String, Object> mapping, EsConnConfig connConfig) throws IOException {
        ...
        request.mapping(Strings.toString(mappingBuilder), XContentType.JSON);
