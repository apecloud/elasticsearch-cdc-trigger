...
public class Es6SourceClientHelper {
    ...
    public static RestHighLevelClient generateEsClient(EsConnConfig esConfig) {
        ...
        builder.setHttpClientConfigCallback(genHttpClientConfigCallBack(esConfig.getUserName(), esConfig.getPassword(),
                esConfig.isCaCertificated(), esConfig.getSecurityFileUrl(), esConfig.getMaxConnCount(),
                esConfig.getMaxConnPerRoute(), esConfig.getKeepAliveSec()));
    ...
    protected static SSLContext initContext(String trustStoreFileUrl, Function<File, SSLContext> func) {
        ...
        try {
            ...
            String errorMsg = "load CA certificate file Fail! err:" + ExceptionUtils.getRootCauseMessage(e)
                    + ",path:" + crtFile.getAbsolutePath();
            throw new RuntimeException(errorMsg);
        }
    }
